...
For each individual game, the program will--randomly--either assign "player" or "computer" as the starting player, or ask you to choose. Do you want to begin? (enter "yes" or "no"): `)
...
function detectImmediateThreat(board) { // function sometimes ignores line 1
  for (let line = 0; line < WINNING_LINES.length; line ++) {
...
function displayStartingRules() {
  let acceptTerms = rlSync.question(`The program will, randomly, either assign "player" or "computer" as the starting player, or ask you to choose. Do you want to begin? (enter "yes" or "no"):`)
  acceptTerms = acceptTerms.trim()[0].toLowerCase();
