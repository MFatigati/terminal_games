...
class CreateComputer extends CreatePlayer {
  ...
  updateComputerWeightedChoices = function(playerMove, gameWinner,
...
class CreateHuman extends CreatePlayer {
  ...
  returnFullChoice = function(choice) {
    let conversions = {
      r: 'rock',
      p: 'paper',
      s: 'scissors',
...
class CreateRules {
  constructor() {
    ...
    returnMoveWinner = function (humanMove, computerMove) {
